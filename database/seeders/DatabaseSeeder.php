...
class DatabaseSeeder extends Seeder
{
    ...
    protected function seedCatalog()
    {
        ...
        foreach( $this->arrayPeliculas as $movies ) {
            $p = new Movie;
            $p->title = $movies['title'];
            $p->year = $movies['year'];
            $p->director = $movies['director'];
            $p->poster = $movies['poster'];
            $p->rented = $movies['rented'];
            $p->synopsis = $movies['synopsis'];
            $p->save();
        }
    }
    ...
    protected function seedUsers()
    {
        ...
        $usuarios = [
            ['name' => 'John', 'email' => 'john@doe.com', 'password' => 'password'],
